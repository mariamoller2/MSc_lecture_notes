...
<object width="60%" data="http://138.68.85.121/chart.svg"></object>
...
In case you need to change your URLs in the [`repositories.py`](https://github.com/itu-devops/MSc_lecture_notes/blob/master/repositories.py) file, please inform us about it.
...
Extra TA time, Fridays after the exercise session, in the same room.
...
<table>
  <tr>
    <td  width="50%">
      <code class="sql hljs remark-code">
      <div class="remark-code-line"><span class="hljs-keyword">create</span> <span class="hljs-keyword">table</span> <span class="hljs-keyword">user</span> (</div><div class="remark-code-line">&nbsp;&nbsp;user_id <span class="hljs-built_in">integer</span> primary <span class="hljs-keyword">key</span> autoincrement,</div><div class="remark-code-line">&nbsp;&nbsp;username <span class="hljs-keyword">string</span> <span class="hljs-keyword">not</span> <span class="hljs-literal">null</span>,</div><div class="remark-code-line">&nbsp;&nbsp;email <span class="hljs-keyword">string</span> <span class="hljs-keyword">not</span> <span class="hljs-literal">null</span>,</div><div class="remark-code-line">&nbsp;&nbsp;pw_hash <span class="hljs-keyword">string</span> <span class="hljs-keyword">not</span> <span class="hljs-literal">null</span></div><div class="remark-code-line">);</div>
      <div class="remark-code-line"><span class="hljs-keyword">create</span> <span class="hljs-keyword">table</span> follower (</div><div class="remark-code-line">&nbsp;&nbsp;who_id <span class="hljs-built_in">integer</span>,</div><div class="remark-code-line">&nbsp;&nbsp;whom_id <span class="hljs-built_in">integer</span></div><div class="remark-code-line">);</div>
      <div class="remark-code-line"><span class="hljs-keyword">create</span> <span class="hljs-keyword">table</span> message (</div><div class="remark-code-line">&nbsp;&nbsp;message_id <span class="hljs-built_in">integer</span> primary <span class="hljs-keyword">key</span> autoincrement,</div><div class="remark-code-line">&nbsp;&nbsp;author_id <span class="hljs-built_in">integer</span> <span class="hljs-keyword">not</span> <span class="hljs-literal">null</span>,</div><div class="remark-code-line">&nbsp;&nbsp;<span class="hljs-built_in">text</span> <span class="hljs-keyword">string</span> <span class="hljs-keyword">not</span> <span class="hljs-literal">null</span>,</div><div class="remark-code-line">&nbsp;&nbsp;pub_date <span class="hljs-built_in">integer</span>,</div><div class="remark-code-line">&nbsp;&nbsp;flagged <span class="hljs-built_in">integer</span></div><div class="remark-code-line">);</div></code>
    </td>
    <td>
...
<table>
  <tr>
    <td width="50%">
<code class="python hljs remark-code"><div class="remark-code-line"><span class="hljs-keyword">from</span> dataclasses <span class="hljs-keyword">import</span> dataclass</div><div class="remark-code-line"><span class="hljs-keyword">from</span> typing <span class="hljs-keyword">import</span> List</div><div class="remark-code-line"><span class="hljs-keyword">from</span> datetime <span class="hljs-keyword">import</span> datetime</div><div class="remark-code-line"></div><div class="remark-code-line"><span class="hljs-meta">@dataclass</span></div><div class="remark-code-line"><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">User</span>:</span></div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;username: str</div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;email: str</div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;pw_hash: str</div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;tweets: List[<span class="hljs-string">"Message"</span>]</div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;follows: List[<span class="hljs-string">"User"</span>]</div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;followers: List[<span class="hljs-string">"User"</span>]</div><div class="remark-code-line"></div><div class="remark-code-line"><span class="hljs-meta">@dataclass</span></div><div class="remark-code-line"><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Message</span>:</span></div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;author: User</div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;text: str</div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;pub_date: datetime = <span class="hljs-keyword">None</span></div><div class="remark-code-line">&nbsp;&nbsp;&nbsp;&nbsp;flagged: bool</div></code>
    </td>
    <td>
      <img src="images/class_diagram.png" width="100%">
    </td>
  </tr>
</table>
...
timeline = (
    users.select(
      lambda x: x.username == user_name
    ).tweets + users.select_many(
      lambda x: x.follows
    ).select_many(
      lambda x: x.tweets
    )
...
Source: https://web.archive.org/web/20170601101557/https://www.moviri.com/2014/01/active-passive-monitoring/
