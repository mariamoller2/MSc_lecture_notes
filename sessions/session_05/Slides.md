...
<iframe
    width="900"
    height="500"
    src="http://134.209.249.148/release_activity_weekly.svg"
    frameborder="0"
    allowfullscreen
></iframe>
...
<iframe
    width="900"
    height="500"
    src="http://134.209.249.148/commit_activity_weekly.svg"
    frameborder="0"
    allowfullscreen
></iframe>
...
In case you have not done so yet (two groups), send a pull request to `repositories.py` in our central repository: https://github.com/itu-devops/MSc_lecture_notes/blob/master/repositories.py!
...
When I google the two definitions, I encounter a lot of sources that define the two the other way around, stating that continuous deployment is an extension of continuous delivery ...
...
<!--
 (2) practice of delivering feature increments immediately to customers, often through the use of small batches of work and automation technology ([A Guide to the Project Management Body of Knowledge (PMBOK(R) Guide) -- Eighth Edition](https://www.pmi.org/standards/pmbok))
 -->

---

### I suggest to send an erratum.

I suggest to send an erratum to N. Gift et al. [_"Python for DevOps"_](https://www.oreilly.com/library/view/python-for-devops/9781492057680/)

* Reported errata: https://www.oreilly.com/catalog/errataunconfirmed.csp?isbn=0636920274902
* Report erratum: https://www.oreilly.com/cs/catalog/create/errata/?b=68285
